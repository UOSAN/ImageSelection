...
imgdir = 'C:\Users\sticelab\Desktop\CraveControl'; %'S:\stice\Cognitive paradigms\Attentional retraining\Programmed by Erik\MasterPics_NEW';

subj_imgdir = [imgdir filesep sprintf('%d',ID)];

%Test if subject directory already exists. If it doesn't, make that
%directory.
if isdir(subj_imgdir) && SESS == 1
...
% ASK WHAT SHOULD HAPPEN IF ITS SESSION > 1
elseif SESS == 1
    mkdir(subj_imgdir)
end
